...
class BeerControllerTest {
    ...
    //Maps POJO to JSON
    //Serializes Java objects into JSON or deserializes JSON into Java Objects
    @Autowired
    ...
    //Will run before each test and rebuild object in between each test
    @BeforeEach
    void setUp() {
    ...
    void testUpdateBeer() throws Exception {
        ...
        verify(beerService).getBeerById(any(UUID.class), any(Beer.class));
    }
    ...
    //Cut this when testing global exception controller
    @Test
